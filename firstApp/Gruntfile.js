...
module.exports = function(grunt) {
  ...
  // grunt.file.expand({cwd:"./static/js/"}, "**/*.js").forEach( function (file) {  
  //     if (file !== 'opt.js') {
        ...
        files: [
          {
            ...
            cwd: 'src/public/js/requirejs',      // Src matches are relative to this path.
    ...
    requirejs: {
      ...
      almond: {
        options: {
          ...
          preserveLicenseComments: false,
          //insertRequire: ['main'],
          name: "public/js/almond/almond", // assumes a production build using almond
  ...
  // Default task.
  grunt.registerTask('default', ['cssbuild', 'htmlbuild', 'requirejsmin', 'requirebuild', 'cpjs', 'imagebuild']);
